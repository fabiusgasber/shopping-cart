...
describe("Product Page", () => {
    ...
    it("renders product page", () => {
        const { container } = render(<MemoryRouter><ProductPage /></MemoryRouter>);
        expect(container).toMatchSnapshot();
    })

    it("renders a product",  () => {
        render(<MemoryRouter><ProductPage propItem={ dummyItem } /></MemoryRouter>);
    ...
    it.todo("should call the addToBag function when user clicks add to bag", async () => {
        const user = userEvent.setup();
        const addToBag = vi.fn();
        render(<MemoryRouter><ProductPage propItem={ dummyItem } onClick={ addToBag } /></MemoryRouter>);
